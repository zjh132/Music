...
public interface API {
    // Base API
    String API_BASE = "https://music.163.com/";

    String BASE_URL_NETEASE = "https://music.163.com/";
     ...
     */
    interface Baidu {
        String BASE_URL_BAIDU = "https://music.163.com/";
        ...
        interface HotArtists {
            String rtpType = Baidu.BASE_URL_BAIDU + "#/discover/artist";
